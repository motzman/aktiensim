...
<button onclick="window.location.href='logout.php'" class="logout_button">🚪 Logout</button>
...
<form method="POST" action="">
    ...
    <button type="submit">Aktie erstellen</button>
</form>


<h2>Gespeicherte Aktien</h2>
    ...
    if ($result && $result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            echo "<tr>
                    ...
                    <td><a href='buy_form.php?stock_id=" . htmlspecialchars($row['id']) . "' class='bg-white p-1 font-bold text-white'>Buy/Sell</a></td>
                  </tr>";
        }
    } else {
